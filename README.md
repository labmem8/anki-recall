...
The program has 5 states:
  ...
  <br>You know you are in this state if you see `Anki time!` popup. 
  ##### Distracted state
  ...
  <br>You know you are in this state if you see `Anki is closed, see ya!` popup (if you didn't get another popup before about moving to cooldown state).
  ##### Cooldown state
  ...
  <br>You know you are in this state if you see `Work sprint done. Good job!` popup.
  ...
  <br>You know you are in this state if you see `Snoozed for 30 min Zzz` popup.
  ...
  <br>You know you are in this state if you see `Done with Anki for today!` popup.
